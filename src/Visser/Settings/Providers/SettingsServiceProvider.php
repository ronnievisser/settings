<?php namespace Visser\Settings\Providers;

use Illuminate\Contracts\Config\Repository;
use Illuminate\Contracts\Events\Dispatcher;
use Illuminate\Support\ServiceProvider;
use Visser\Settings\Console\SettingsTableCommand;
use Visser\Settings\Factory;
use Visser\Settings\Settings;
...
class SettingsServiceProvider extends ServiceProvider
{
     ...
     *
     * @param \Visser\Settings\Settings $settings
    ...
    {
        $this->app->alias('settings.factory', 'Visser\Settings\Contracts\Factory');

        $this->app->alias('settings.repository', 'Visser\Settings\Contracts\Repository');

        $this->app->alias('settings.key_generator', 'Visser\Settings\Contracts\KeyGenerator');

        $this->app->alias('settings.context_serializer', 'Visser\Settings\Contracts\ContextSerializer');

        $this->app->alias('settings.value_serializer', 'Visser\Settings\Contracts\ValueSerializer');

        $this->app->alias('settings', 'Visser\Settings\Settings');
    }
